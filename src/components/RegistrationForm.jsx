                  ...
                  />
                    ...
                    <div
                        ...
                        <button
                            disabled={isLoading}
                            type="submit"
                            className="disabled: rounded-md bg-rose-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-rose-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-600"
                        >
                            {isLoading ? 'loading' : <FormattedMessage id="submit"/>}
